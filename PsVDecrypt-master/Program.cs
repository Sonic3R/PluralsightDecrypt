...
namespace PsVDecrypt
{
    ...
    {
        private static readonly string OutputDir = @"C:\Users\mteodorescu\Downloads\Pluralsight"; // Path.Combine(Directory.GetCurrentDirectory(), "output");
        ...
        private static void DecryptCourse(string courseSrcDir)
        {
            ...
            var courseDstDir = Path.Combine(OutputDir, (string)dataTable.Rows[0]["Title"]);
            courseDstDir = Util.GetCorrectPath(courseDstDir);
